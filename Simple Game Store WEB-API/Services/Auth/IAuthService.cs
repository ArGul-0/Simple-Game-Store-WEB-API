...
namespace Simple_Game_Store_WEB_API.Services.Auth
{
    public interface IAuthService
    {
        ...
        /// </summary>
        /// <returns>A Result Object Containing A String Value, Which Could Be An Authentication Token Or A Success Message, Or An Error If The Authentication Fails.</returns>
        ...
        /// </summary>
        /// <returns>A Result Object Containing A String Value, Which Could Be A Success Message Or An Authentication Token If The Registration Is Successful, Or An Error If The Registration Fails Due To Validation Issues, Duplicate Username / Email, Or Other Errors.</returns>
