...
namespace Simple_Game_Store_WEB_API.Services.Genres
{
    public class GenreErrors
    {
        ...
        public static readonly Error GenreHasAssociatedGames = new("GenreHasAssociatedGames", "Cannot delete genre because there are games associated with it."); // Error For When Trying To Delete A Genre That Has Games Associated With It
    }
}
